...
export default class ThresholdComponent extends Rete.Component {
  constructor() {
    super('Threshold');
    this.path = 'Color';
  }
  ...
  builder(node) {
    ...
    tolerance.addControl(new FloatInputControl(this.editor, 'tolerance', false, 0.04));
  ...
  worker(node, inputs, outputs) {
    ...
    outputs.o0 = ModelBuilder.compose(inputs.i1[0],
      ModelBuilder.buildFunctionWithArgs('thresh', threshold, tolerance));
  }
}
